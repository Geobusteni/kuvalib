...
const ROLE_KEY = { ADMIN: 'admin', USER: 'user', GUEST: 'guest' } as const
  ...
  return (
    <div className="flex flex-col gap-6">
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-zinc-200 dark:border-zinc-800">
              <th className="px-4 py-3 text-left font-medium text-zinc-500">{t('columns.email')}</th>
              <th className="hidden px-4 py-3 text-left font-medium text-zinc-500 sm:table-cell">{t('columns.name')}</th>
              <th className="hidden px-4 py-3 text-left font-medium text-zinc-500 md:table-cell">{t('columns.username')}</th>
              <th className="px-4 py-3 text-left font-medium text-zinc-500">{t('columns.role')}</th>
      ...
      {adding ? (
        ...
        >
          <h2 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">{t('addUser')}</h2>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            >
              ...
              <option value="GUEST">{t('roleOptions.guest')}</option>
            </select>
          </div>
            ...
            <>
              <div className="flex flex-col gap-1.5">
                <label htmlFor="username" className="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                  {t('username')} <span className="text-red-500" aria-hidden>*</span>
                </label>
              ...
              <div className="flex flex-col gap-1.5">
                <label htmlFor="password" className="text-sm font-medium text-zinc-700 dark:text-zinc-300">
                  {t('password')} <span className="text-red-500" aria-hidden>*</span>
                </label>
