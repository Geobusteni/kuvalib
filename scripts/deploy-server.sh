...
echo ""
echo "ℹ️  This builds on the server. The recommended flow is the prebuilt"
echo "   artifact — see DEPLOYMENT.md and ./scripts/update-from-github.sh."
echo ""
echo "🌐 Run it as a self-restarting service (starts on boot, restarts on any stop):"
echo ""
echo "   ./scripts/install-service.sh"
echo ""
echo "   # or, without systemd, with PM2:"
echo "   pm2 start .next/standalone/server.js --name kuvalib && pm2 save && pm2 startup"
echo ""
